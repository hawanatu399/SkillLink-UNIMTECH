...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Recalculate the Uploader's Reputation
    |--------------------------------------------------------------------------
    */

    $owner_result = mysqli_query($conn, "SELECT user_id FROM resources WHERE id = " . (int) $resource_id);
    if ($owner_row = mysqli_fetch_assoc($owner_result)) {
        recalculate_reputation($conn, $owner_row['user_id']);
    }
